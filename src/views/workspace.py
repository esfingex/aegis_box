...
class WorkspaceFrame(QFrame):
    """Central view frame component for Aegis Box, managing lists of apps/sessions/networks."""
    def __init__(self, main_window, parent=None):
        ...
        self.title_lbl = QLabel("Sesiones de Sandbox Pendientes")
        self.title_lbl.setObjectName("view-title")
        title_layout.addWidget(self.title_lbl)
        title_layout.addStretch()
        
        # Dynamic Add Buttons
        self.btn_add_app = QPushButton("+ Aislar Aplicación")
        ...
        self.btn_add_profile = QPushButton("+ Nuevo Perfil")
        ...
        self.btn_add_network = QPushButton("+ Nueva Red Virtual")
        ...
        self.table.setHorizontalHeaderLabels(["ID Sesión", "Aplicación", "Perfil Utilizado", "Tamaño Overlay"])
